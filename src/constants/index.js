...
const experiences = [
  {
    ...
    points: [
      "Assisted four junior web developers weekly",
  ...
  {
    title: "Self Employed",
    company_name: "Chisom Freedom Nwanoruo",
    icon: self,
    iconBg: "#383E56",
    date: "Jan 2024 - march 2024",
    points: [
      "Made use of tailwind css, React.js to create a prototype of an e-commerce website",
